...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [3] = {
    ...
    [sym__inner_expression] = STATE(12),
    [sym_call] = STATE(12),
    [sym_bool] = STATE(8),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [24] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(9),
  ...
  [43] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_bool, 1),
  ...
  [53] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 3),
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 4),
};
